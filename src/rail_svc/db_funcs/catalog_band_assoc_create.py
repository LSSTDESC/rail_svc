"""CatalogBandAssoc creation operations.
...
from ..db import Band, CatalogBandAssoc, CatalogTag
from .row_create import RowCreateBase, RowCreateContext

logger = logging.getLogger(__name__)

__all__ = ["CatalogBandAssocCreate", "catalog_band_assoc_creator"]


class CatalogBandAssocCreate(RowCreateBase[CatalogBandAssoc]):
...
catalog_band_assoc_creator: CatalogBandAssocCreate = CatalogBandAssocCreate(
    RowCreateContext.from_db_class(CatalogBandAssoc)
)
